...
export const Search = () => {
	...
	return (
		<div
			ref={ref}
			className="min-h-[32px] h-[53px] mb-3 flex items-center  bg-[color:var(--background-primary)] z-10 sticky top-0"
		>
			<label className="h-[43px] rounded-full bg-[color:var(--background-third)] w-full relative group border border-transparent bg
			
			focus-within:bg-[color:var(--background-primary)] focus-within:border-[#1d9bf0]">
