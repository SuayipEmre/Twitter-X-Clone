...
export const Post = ({ post }) => {
    ...
    return (
        <div className='px-4 py-3 border-b gap-3 border-[color:var(--background-third)] flex relative before:transition-colors  before:opacity-50 before:absolute before:z-[-1]  before:inset-0 before:hover:bg-[color:var(--background-secondary)]'>
