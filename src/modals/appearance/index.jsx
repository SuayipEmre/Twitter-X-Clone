...
export const AppearanceModal = ({ close }) => {
				...
				<div className="grid gap-3">
					...
					<section >
						...
						<div className='bg-[color:var(--background-secondary) p-4 rounded-2xl flex  items-center gap-5  '>
							...
							<div style={{width:fontSizePercent}} className='absolute top-0 h-full left-0 rounded-full bg-[color:var(--color-primary)]' />
							<div className='flex justify-between absolute  w-[calc(100%+16px)] -top-3.5 -left-[7px]   '>
							{
									fontSizes.map((fs, idx) => (
										...
										className=
										{classNames('before:absolute before:inset-0 before:rounded-full before:hover:bg-[color:var(--color-secondary)] before:opacity-30 w-8 h-8 rounded-full flex items-center justify-center relative ',{
						...
						<div className='bg-[color:var(--background-secondary) py-2 rounded-2xl flex items-center justify-around  '>
							{
								colors.map((c, idx) => (
									<button
										...
										style={{ '--bg': c.primary }}
										className='w-[40px] h-[40px] rounded-full bg-[color:var(--bg)] flex items-center justify-center text-white' key={idx}>
										{
					...
					<section>
						...
						<div className="px-4 mb-3 grid gap-2 py-2 grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
							<button
								onClick={() => {
									setColor({
										...color,
							...
							<button
								...
								className={classNames("h-[64px] pr-3 pl-2bg-[#15202b] text-[#f7f9f9] border font-bold border-white/10 rounded  group flex items-center gap-1.5", {
							...
							>
								<div className='w-[40px]  h-[40px]  rounded-full group-hover:bg-white/10 flex items-center justify-center flex-shrink-0'>
									<div className={classNames('w-5 h-5 rounded-full border-[2px] border-[#5c6373] flex items-center justify-center', {
							...
							<button
								...
								className={classNames("h-[64px]  pr-3 pl-2 bg-black text-[#f7f9f9] border font-bold border-white/10 rounded group flex items-center gap-1.5", {
									"!border-[color:var(--color-primary)] !border-2": backgroundColor.name === 'darker'
								})}
							>
								<div className='w-[40px] h-[40px] rounded-full group-hover:bg-white/10 flex items-center justify-center flex-shrink-0'>
									<div className={classNames('w-5 h-5 rounded-full border-[2px] border-[#3e4144] flex items-center justify-center', {
